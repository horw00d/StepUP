...
def run_test():
    ...
    test_participants = ['001', '002', '003', '004', '005'] # Replace with your actual 5 selected IDs
    test_shoes = ['BF'] # e.g., Canvas Shoes
    test_speeds = ['W1'] # e.g., Preferred Speed

    print(f"Fetching data for Participants: {test_participants}")
    df_raw = data.fetch_cross_trial_data(part_ids=test_participants, shoes=test_shoes, speeds=test_speeds)
