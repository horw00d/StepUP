...
def get_dynamic_outlier_layout(tab_name):
    ...
    return html.Div(
        ...
        children=[
            html.Label(
                "Dynamic Outlier Classification:",
                    ...
                    html.Div(
                        ...
                        children=[
                            dcc.Dropdown(
                                ...
                                value=(
                                    OPTIONS_PART[0]["value"] if OPTIONS_PART else None
                                ),
                            ...
                            dcc.Dropdown(
                                ...
                                value=(
                                    OPTIONS_SHOE[0]["value"] if OPTIONS_SHOE else None
                                ),
                            ...
                            dcc.Dropdown(
                                ...
                                value=(
                                    OPTIONS_SPEED[0]["value"] if OPTIONS_SPEED else None
                                ),
                                placeholder="Speed",
                                style={"width": "120px"},
                            ),
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dcc.Input(
                                        id={"type": "query-input", "tab": "single"},
                                        type="text",
                                        placeholder="e.g., peak_grf > 800 and is_outlier == 'Normal'",
                                        debounce=True,
                                        style={
                                            "flex": "1",
                                            "padding": "0 12px",
                                    ...
                                    html.Button(
                                        "Clear",
                                        id={"type": "clear-query-btn", "tab": "single"},
                                        n_clicks=0,
                                        style={
                                            "height": "38px",
                                            "padding": "0 15px",
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    with_spinner(
                                        dcc.Graph(
                                            id="walkway-plot", style={"height": "100%"}
                                        )
                                    )
                                ],
                            ),
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    with_spinner(
                                        dcc.Graph(
                                            id="heatmap-plot", style={"height": "400px"}
                                        )
                                    )
                                ],
                            ),
                ...
                children=[
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Input(
                                id={"type": "query-input", "tab": "cross"},
                                type="text",
                                placeholder="e.g., age >= 60 and peak_grf < 600",
                                debounce=True,
                                style={
                                    "flex": "1",
                                    "padding": "0 12px",
                            ...
                            html.Button(
                                "Clear",
                                id={"type": "clear-query-btn", "tab": "cross"},
                                n_clicks=0,
                                style={
                                    "height": "38px",
                                    "padding": "0 15px",
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Dropdown(
                                id="ct-group-dd", value="footwear", clearable=False
                            ),
                        ],
                    ),
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Dropdown(
                                id="ct-color-dd", value="speed", clearable=False
                            ),
                        ],
                    ),
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    with_spinner(
                                        dcc.Graph(
                                            id="ct-box-plot", style={"height": "100%"}
                                        )
                                    )
                                ],
                            ),
